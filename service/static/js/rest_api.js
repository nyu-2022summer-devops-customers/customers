$(function () {
    ...
    function update_form_data(res) {
        ...
        $("#customer_first_name").val(res.customer_first_name);
        $("#customer_last_name").val(res.customer_last_name);
        $("#customer_nickname").val(res.customer_nickname);
        $("#customer_password").val(res.customer_password);
        $("#customer_email").val(res.customer_email);
        $("#customer_gender").val(res.customer_gender);
        $("#customer_birthday").val(res.customer_birthday);
        if (res.customer_is_active == true) {
